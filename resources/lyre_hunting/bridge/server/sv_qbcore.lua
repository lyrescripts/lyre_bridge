...
function bridge:getPlayerFromId(playerId)
	...
	player.addAmmo = function(ammoItem, weaponName, amount)
		-- QBCore stores ammo as a regular inventory item ("ammo-pistol", etc.).
		-- The weaponName argument is unused on QBCore but kept in the signature
	...
	player.canCarryItem = function(itemName, count)
		-- QBCore inventory systems typically handle weight internally.
		-- Some QBCore setups don't have this function, so fallback to true.
