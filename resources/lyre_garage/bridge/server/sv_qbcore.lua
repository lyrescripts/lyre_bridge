...
local function getPlayerSourcesByIdentifier(qbObject)
	...
	local values = {}
	local players = qbObject.Functions.GetQBPlayers()
...
RegisterNetEvent("QBCore:Server:PlayerLoaded", invalidatePlayerIdentifierCache)
...
function bridge:getPlayerFromId(playerId)
	...
	_player.getAdminRank = function()
		local permissions = self.object.Functions.GetPermission(playerId)
		return permissions
	end
