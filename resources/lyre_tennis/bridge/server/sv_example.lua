...
function bridge:init()
	-- Customize this function, this function is executed when the bridge is detected.
	-- You can for example set self.object to the shared object of your framework.
end
...
function bridge:getPlayerFromId(playerId)
	-- Customize this function to return a player object from your framework
	-- The player object must implement the following methods:
	--   player.getIdentifier() -> string
	--   player.getName() -> string
	--   player.showNotification(message) -> void
