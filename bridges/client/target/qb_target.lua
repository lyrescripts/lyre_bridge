...
function provider:addLocalEntity(entity, options)
    exports["qb-target"]:AddTargetEntity(entity, { options = convertOptions(options), distance = resolveDistance(options, 2.5) })
end
...
function provider:addGlobalVehicle(options)
    exports["qb-target"]:AddGlobalVehicle({ options = convertOptions(options), distance = resolveDistance(options, 2.5) })
end
